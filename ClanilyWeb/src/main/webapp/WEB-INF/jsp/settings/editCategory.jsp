...
<body class="fixed-navbar sidebar-scroll">
	...
	<div id="wrapper">
		...
		<div class="content">
			...
			<form:form method="post" class="form-horizontal" modelAttribute="category" name="editCategoryForm" action="/category/editCategory">
							...
							<div class="panel-heading">
											...
											<div class="col-lg-8">
												...
												<c:choose>
													<c:when test="${category.type.equals('Expense') }">
														<a href="#" class="btn btn-primary2" >Expense</a>
													</c:when>
													<c:when test="${category.type.equals('Income') }">
														<a href="#" class="btn btn-primary2 ">Income</a> &nbsp; 
													</c:when>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<form:select path="tag" class="js-source-states" style="width: 85%;">
