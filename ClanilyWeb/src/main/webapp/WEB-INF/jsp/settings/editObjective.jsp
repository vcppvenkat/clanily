...
<body class="fixed-navbar sidebar-scroll">
	...
	<div id="wrapper">
		...
		<div class="normalheader small-header">
			<div class="hpanel">
				<div class="panel-body">
					...
					<small>Update an objective detail</small>
				</div>
			</div>
		</div>
		...
		<div class="content">
			...
			<form:form method="post" class="form-horizontal" modelAttribute="obj" name="newObjectiveForm" action="/objective/editObjective">
				<form:hidden path="objectiveId" />
				<div class="row">
					<div class="col-lg-12">
						<div class="hpanel">
							<div class="panel-heading">
								<h4>Update objective details</h4>
							</div>
							<div class="panel-heading">
